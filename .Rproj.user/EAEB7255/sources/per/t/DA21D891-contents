...
# TODO
#check on log transformations. keep working through the analysis
...
#read data
clean_species <- read.csv("./clean data/clean_species2020-03-18.csv")
...
#clip to all species (not just complete cases)
...
trait_summary <- aggregate(plot_data[, c(6, 21:33)], by = list(plot_data$FG, plot_data$Life.Form), FUN = mean, na.rm = TRUE)
